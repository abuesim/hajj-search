...
<header>
  {SWITCHER}
  <div class="hdr-row">
    <h1>🕋 {H1} <span style="font-size:.55em;opacity:.6;font-weight:400">v4.0</span></h1>
...
<header>
  {SWITCHER}
  <div class="hdr-row"><h1>📷 البحث السريع <span style="font-size:.6em;opacity:.6;font-weight:400">v4.0</span></h1><a href="{SEARCH_LINK}" class="nav-link">🔍 بحث عادي</a></div>
</header>
...
<header>
  {SWITCHER}
  <div class="hdr-row">
    <h1>📊 {H1} <span style="font-size:.6em;opacity:.6;font-weight:400">v4.0</span></h1>
